...
QUIZ_EXAMPLES: list[dict[str, Any]] = [
    ...
    _example_doc("quiz", "es", "General Knowledge", {
        "game_type": "quiz",
    ...
    _example_doc("quiz", "en", "General Knowledge", {
        "game_type": "quiz",
    ...
    # ── Science & Nature · ES ─────────────────────────────────────
    _example_doc("quiz", "es", "Science & Nature", {
        "game_type": "quiz",
        ...
        "questions": [
            ...
            },
            {
                ...
                "options": ["Electromagnética", "Nuclear fuerte", "Gravitatoria", "Nuclear débil"],
                "correct_index": 2,
    ...
    _example_doc("quiz", "en", "Entertainment: Film", {
        "game_type": "quiz",
    ...
    _example_doc("quiz", "es", "Art", {
        ...
        "questions": [
            ...
            },
            {
                ...
                "options": ["Museo del Prado", "Museo del Louvre", "Galería Uffizi", "Museo Británico"],
                "correct_index": 1,
    ...
    # ── Geography · ES ────────────────────────────────────────────
    _example_doc("quiz", "es", "Geography", {
        "game_type": "quiz",
...
WORD_PASS_EXAMPLES: list[dict[str, Any]] = [
    # ── General Knowledge · ES ────────────────────────────────────
    _example_doc("word-pass", "es", "General Knowledge", {
        "game_type": "word-pass",
        "title": "Pasapalabra — Cultura General",
        "difficulty_percentage": 45,
        "words": [
            {"letter": "A", "hint": "Sexto continente descubierto, cubierto de hielo", "answer": "Antártida", "starts_with": True},
            {"letter": "B", "hint": "Instrumento de viento metal con pistones", "answer": "Bombardino", "starts_with": True},
            {"letter": "C", "hint": "Capital de Francia", "answer": "Ciudad de París", "starts_with": True},
            {"letter": "D", "hint": "Deporte que se practica en una piscina", "answer": "Natación", "starts_with": False},
            {"letter": "E", "hint": "País sudamericano cuya capital es Quito", "answer": "Ecuador", "starts_with": True},
            {"letter": "F", "hint": "Proceso por el que las plantas elaboran su alimento", "answer": "Fotosíntesis", "starts_with": True},
            {"letter": "G", "hint": "Fuerza que atrae los cuerpos hacia el centro de la Tierra", "answer": "Gravedad", "starts_with": True},
            {"letter": "H", "hint": "Elemento químico más abundante del universo", "answer": "Hidrógeno", "starts_with": True},
            {"letter": "I", "hint": "Isla más grande de Europa", "answer": "Islandia", "starts_with": True},
            {"letter": "J", "hint": "Deporte de combate olímpico de origen japonés", "answer": "Judo", "starts_with": True},
            {"letter": "L", "hint": "Satélite natural de la Tierra", "answer": "Luna", "starts_with": True},
            {"letter": "M", "hint": "Unidad de longitud equivalente a mil metros", "answer": "Kilómetro", "starts_with": False},
            {"letter": "N", "hint": "Gas que compone el 78 % de la atmósfera terrestre", "answer": "Nitrógeno", "starts_with": True},
            {"letter": "O", "hint": "Cuerpo celeste que gira alrededor de una estrella", "answer": "Órbita", "starts_with": True},
            {"letter": "P", "hint": "Profesional que estudia y trata la mente humana", "answer": "Psicólogo", "starts_with": True},
            {"letter": "R", "hint": "Estación del año entre el invierno y el verano", "answer": "Primavera", "starts_with": False},
            {"letter": "S", "hint": "Estrella más cercana a la Tierra", "answer": "Sol", "starts_with": True},
            {"letter": "T", "hint": "Instrumento para medir la temperatura", "answer": "Termómetro", "starts_with": True},
            {"letter": "V", "hint": "Planeta conocido como el lucero del alba", "answer": "Venus", "starts_with": True},
            {"letter": "Z", "hint": "Animal equino con rayas blancas y negras", "answer": "Zebra", "starts_with": True},
        ],
    }),

    # ── General Knowledge · EN ────────────────────────────────────
    _example_doc("word-pass", "en", "General Knowledge", {
        "game_type": "word-pass",
        "title": "Word Wheel — General Knowledge",
        "difficulty_percentage": 45,
        "words": [
            {"letter": "A", "hint": "The continent covered in ice at the South Pole", "answer": "Antarctica", "starts_with": True},
            {"letter": "B", "hint": "System of governance where citizens vote for representatives", "answer": "Ballot", "starts_with": True},
            {"letter": "C", "hint": "Capital city of Australia", "answer": "Canberra", "starts_with": True},
            {"letter": "D", "hint": "Planet known for its dramatic ring system", "answer": "Saturn", "starts_with": False},
            {"letter": "E", "hint": "The line around the middle of the Earth at 0° latitude", "answer": "Equator", "starts_with": True},
            {"letter": "F", "hint": "The study of fossils and ancient life", "answer": "Fossil", "starts_with": True},
            {"letter": "G", "hint": "Force of attraction between two masses", "answer": "Gravity", "starts_with": True},
            {"letter": "H", "hint": "Chemical element with symbol H and atomic number 1", "answer": "Hydrogen", "starts_with": True},
            {"letter": "I", "hint": "Large island nation in the North Atlantic near the Arctic", "answer": "Iceland", "starts_with": True},
            {"letter": "J", "hint": "Planet famous for its Great Red Spot", "answer": "Jupiter", "starts_with": True},
            {"letter": "L", "hint": "Natural satellite orbiting the Earth", "answer": "Luna", "starts_with": True},
            {"letter": "M", "hint": "Red planet and fourth from the Sun", "answer": "Mars", "starts_with": True},
            {"letter": "N", "hint": "Gas making up 78 % of Earth's atmosphere", "answer": "Nitrogen", "starts_with": True},
            {"letter": "O", "hint": "Gas essential for human respiration, about 21% of air", "answer": "Oxygen", "starts_with": True},
            {"letter": "P", "hint": "The study of the mind and behaviour", "answer": "Psychology", "starts_with": True},
            {"letter": "R", "hint": "Electromagnetic radiation we perceive as colours", "answer": "Rainbow", "starts_with": True},
            {"letter": "S", "hint": "The closest star to Earth", "answer": "Sun", "starts_with": True},
            {"letter": "T", "hint": "Instrument used to measure temperature", "answer": "Thermometer", "starts_with": True},
            {"letter": "V", "hint": "Planet often called Earth's twin", "answer": "Venus", "starts_with": True},
            {"letter": "Z", "hint": "Striped equine native to Africa", "answer": "Zebra", "starts_with": True},
        ],
    }),

    # ── Science & Nature · ES ─────────────────────────────────────
    _example_doc("word-pass", "es", "Science & Nature", {
        "game_type": "word-pass",
        "title": "Pasapalabra — Ciencia y Naturaleza",
        "difficulty_percentage": 50,
        "words": [
            {"letter": "A", "hint": "Unidad fundamental de la materia", "answer": "Átomo", "starts_with": True},
            {"letter": "B", "hint": "Ciencia que estudia los seres vivos", "answer": "Biología", "starts_with": True},
            {"letter": "C", "hint": "Unidad básica de los seres vivos", "answer": "Célula", "starts_with": True},
            {"letter": "D", "hint": "Molécula que almacena la información genética", "answer": "ADN", "starts_with": False},
            {"letter": "E", "hint": "Capacidad de un sistema para realizar trabajo", "answer": "Energía", "starts_with": True},
            {"letter": "F", "hint": "Cambio de estado de sólido a líquido", "answer": "Fusión", "starts_with": True},
            {"letter": "G", "hint": "Estudio de las rocas y la estructura terrestre", "answer": "Geología", "starts_with": True},
            {"letter": "H", "hint": "Compuesto químico formado por dos átomos de hidrógeno y uno de oxígeno", "answer": "H₂O", "starts_with": True},
            {"letter": "I", "hint": "Propiedad de un cuerpo de resistir cambios en su movimiento", "answer": "Inercia", "starts_with": True},
            {"letter": "J", "hint": "Unidad de energía en el Sistema Internacional", "answer": "Julio", "starts_with": True},
            {"letter": "L", "hint": "Radiación electromagnética visible al ojo humano", "answer": "Luz", "starts_with": True},
            {"letter": "M", "hint": "Dispositivo que convierte energía eléctrica en movimiento", "answer": "Motor", "starts_with": True},
            {"letter": "N", "hint": "Parte central del átomo que contiene protones y neutrones", "answer": "Núcleo", "starts_with": True},
            {"letter": "O", "hint": "Capa de gas que protege la Tierra de la radiación ultravioleta", "answer": "Ozono", "starts_with": True},
            {"letter": "P", "hint": "Tabla que clasifica los elementos químicos", "answer": "Periódica", "starts_with": True},
            {"letter": "R", "hint": "Transferencia de energía sin medio material de propagación", "answer": "Radiación", "starts_with": True},
            {"letter": "S", "hint": "Conjunto organizado de planetas orbitando una estrella", "answer": "Sistema solar", "starts_with": True},
            {"letter": "T", "hint": "Magnitud que mide el nivel de calor de un cuerpo", "answer": "Temperatura", "starts_with": True},
            {"letter": "V", "hint": "Rapidez con que un objeto cambia de posición", "answer": "Velocidad", "starts_with": True},
            {"letter": "Z", "hint": "Ciencia que estudia los animales", "answer": "Zoología", "starts_with": True},
        ],
    }),

    # ── History · ES ──────────────────────────────────────────────
    _example_doc("word-pass", "es", "History", {
        "game_type": "word-pass",
        "title": "Pasapalabra — Historia Universal",
        "difficulty_percentage": 55,
        "words": [
            {"letter": "A", "hint": "Civilización que construyó pirámides en Tenochtitlán", "answer": "Azteca", "starts_with": True},
            {"letter": "B", "hint": "Muro que dividió una ciudad europea entre 1961 y 1989", "answer": "Berlín", "starts_with": True},
            {"letter": "C", "hint": "Navegante genovés que llegó a América en 1492", "answer": "Colón", "starts_with": True},
            {"letter": "D", "hint": "Periodo histórico también llamado Edad Oscura", "answer": "Edad Media", "starts_with": False},
            {"letter": "E", "hint": "País donde nació la civilización faraónica", "answer": "Egipto", "starts_with": True},
            {"letter": "F", "hint": "Revolución que comenzó en 1789", "answer": "Francesa", "starts_with": True},
            {"letter": "G", "hint": "Imperio que duró del siglo XV al XX con capital en Estambul", "answer": "Otomano", "starts_with": False},
            {"letter": "H", "hint": "Escritura jeroglífica fue creada por esta civilización del Nilo", "answer": "Hieroglífico", "starts_with": True},
            {"letter": "I", "hint": "Revolución tecnológica que comenzó en Gran Bretaña en el siglo XVIII", "answer": "Industrial", "starts_with": True},
            {"letter": "J", "hint": "Jefa de estado francesa ejecutada en la Revolución", "answer": "Juana de Arco", "starts_with": True},
            {"letter": "L", "hint": "Filósofo griego autor de 'La República'", "answer": "Platón", "starts_with": False},
            {"letter": "M", "hint": "Civilización precolombina de la península de Yucatán", "answer": "Maya", "starts_with": True},
            {"letter": "N", "hint": "Líder militar francés que se coronó emperador en 1804", "answer": "Napoleón", "starts_with": True},
            {"letter": "O", "hint": "Juegos de la Antigua Grecia celebrados cada cuatro años", "answer": "Olímpicos", "starts_with": True},
            {"letter": "P", "hint": "Sistema de gobierno de la antigua Atenas basado en el voto ciudadano", "answer": "Democracia", "starts_with": False},
            {"letter": "R", "hint": "Periodo cultural europeo que siguió a la Edad Media", "answer": "Renacimiento", "starts_with": True},
            {"letter": "S", "hint": "Civilización mesopotámica considerada la más antigua", "answer": "Sumeria", "starts_with": True},
            {"letter": "T", "hint": "Barco que se hundió en su viaje inaugural en 1912", "answer": "Titanic", "starts_with": True},
            {"letter": "V", "hint": "Pueblo escandinavo famoso por sus expediciones marítimas", "answer": "Vikingo", "starts_with": True},
            {"letter": "Z", "hint": "Antiguo nombre del río Congo en la época colonial", "answer": "Zaire", "starts_with": True},
        ],
    }),
]
...
TRUE_FALSE_EXAMPLES: list[dict[str, Any]] = [
    _example_doc("true_false", "es", "General Knowledge", {
    ...
    _example_doc("true_false", "en", "Science & Nature", {
        "game_type": "true_false",
...
EDUCATIONAL_RESOURCES: list[dict[str, Any]] = [
    # ── General Knowledge ─────────────────────────────────────────
    _resource_doc("General Knowledge", "es", """
...
"""),
    ...
    _resource_doc("General Knowledge", "en", """
...
"""),
    ...
    # ── Science & Nature ──────────────────────────────────────────
    _resource_doc("Science & Nature", "es", """
...
"""),
    ...
    _resource_doc("Science & Nature", "en", """
...
"""),
    ...
    # ── Entertainment: Film ───────────────────────────────────────
    _resource_doc("Entertainment: Film", "en", """
...
"""),
    ...
    # ── Computers ─────────────────────────────────────────────────
    _resource_doc("Science: Computers", "es", """
...
"""),
    ...
    # ── Mathematics ───────────────────────────────────────────────
    _resource_doc("Science: Mathematics", "es", """
...
"""),
    ...
    # ── Entertainment: Music ──────────────────────────────────────
    _resource_doc("Entertainment: Music", "es", """
...
def get_full_corpus() -> list[dict[str, Any]]:
    ...
    return QUIZ_EXAMPLES + WORD_PASS_EXAMPLES + TRUE_FALSE_EXAMPLES + EDUCATIONAL_RESOURCES
